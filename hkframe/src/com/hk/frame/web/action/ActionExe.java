...
import com.hk.frame.web.exception.NoActionException;
import com.hk.frame.web.http.HkRequest;
import com.hk.frame.web.http.HkRequestImpl;
import com.hk.frame.web.http.HkResponse;
import com.hk.frame.web.http.HkResponseImpl;
import com.hk.frame.web.interceptor.HkIntercepotorUtil;
...
public class ActionExe {
	...
	private final String BUILDEDSYSPARAMETER_KEY = "BUILDEDSYSPARAMETER_KEY";
	...
	public String invokeInterceptor(String mappingUri,
		...
		this.processSysParameter(hkRequest);
		try {
	...
	public void setBuildedSysParameter(HkRequest request,
			boolean buildedSysParameter) {
		request.setAttribute(BUILDEDSYSPARAMETER_KEY, buildedSysParameter);
	}

	public boolean isBuildedSysParameter(HkRequest request) {
		if (request.getAttribute(BUILDEDSYSPARAMETER_KEY) == null) {
			return false;
		}
		return true;
	}

	public void processSysParameter(HkRequest request) {
		if (!this.isBuildedSysParameter(request)) {
