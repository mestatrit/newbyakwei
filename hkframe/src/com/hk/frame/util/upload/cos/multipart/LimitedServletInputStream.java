 ...
 * This is necessary since some servlet containers are slow to notice the end of
 * stream and cause the client code to hang if it tries to read past it.
 * 
 * @author Jason Hunter
...
public class LimitedServletInputStream extends ServletInputStream {
	...
	/**
	 * Implement length limitation on top of the <code>readLine</code> method
	 * of the wrapped <code>ServletInputStream</code>.
	 * 
