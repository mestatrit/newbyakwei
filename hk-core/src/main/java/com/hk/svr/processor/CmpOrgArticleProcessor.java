...
public class CmpOrgArticleProcessor {
	 ...
	 * @throws IOException
	 */
	public CmpOrgArticleUploadFileResult createCmpOrgArticle(
			CmpOrgArticle cmpOrgArticle,
			CmpOrgArticleContent cmpOrgArticleContent, File[] files, int topIdx)
			throws Exception {
		this.cmpOrgArticleService.createCmpOrgArticle(cmpOrgArticle,
				cmpOrgArticleContent);
		CmpOrgArticleUploadFileResult cmpOrgArticleUploadFileResult = null;
		if (files != null) {
			cmpOrgArticleUploadFileResult = this.saveFile(cmpOrgArticle
					.getCompanyId(), files, cmpOrgArticle, topIdx);
		}
		if (cmpOrgArticleUploadFileResult != null
				&& cmpOrgArticleUploadFileResult.isFileUploadError()) {
	 ...
	 *            2010-5-10
	 */
	public CmpOrgArticleUploadFileResult updateCmpOrgArticle(
			CmpOrgArticle cmpOrgArticle,
			CmpOrgArticleContent cmpOrgArticleContent, File[] files, int topIdx)
			throws Exception {
		CmpOrgArticleUploadFileResult cmpOrgArticleUploadFileResult = null;
		...
		this.cmpOrgArticleService.updateCmpOrgArticle(cmpOrgArticle,
				cmpOrgArticleContent);
		if (cmpOrgArticleUploadFileResult != null
				&& cmpOrgArticleUploadFileResult.isFileUploadError()) {
			throw new Exception("imgupdateerror");
	...
	private CmpOrgArticleUploadFileResult saveFile(long companyId,
			File[] files, CmpOrgArticle cmpOrgArticle, int topIdx) {
	...
	public void deleteCmpArticleFile(long companyId, long cmpArticleOid,
			long cmpFileOid) {
		...
		if (cmpOrgArticle != null) {
			if (cmpOrgArticle.getPath() != null
					&& cmpOrgArticle.getPath().equals(cmpOrgFile.getPath())) {
