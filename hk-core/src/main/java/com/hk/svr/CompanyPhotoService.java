...
public interface CompanyPhotoService {
	...
	List<CompanyPhoto> getPhotoListByCompanyId(long companyId, int begin,
			int size);

	List<CompanyPhoto> getPhotoListByCompanyIdVoteStyle(long companyId,
			int begin, int size);

	List<CompanyPhoto> getPhotoListByCompanyIdNoLogo(long companyId,
			String logoPath, int begin, int size);

	Map<Long, CompanyPhoto> getCompanyPhotoMapInId(long companyId,
			List<Long> idList);
	 ...
	 * @return
	 */
	List<CompanyPhoto> getPreCompanyPhotoListByCompanyId(long companyId,
	 ...
	 * @return
	 */
	List<CompanyPhoto> getNextCompanyPhotoListByCompanyId(long companyId,
			long photoId, int begin, int size);
	...
	List<CmpPhotoSetRef> getCmpPhotoSetRefListByCompanyIdAndSetId(
	...
	List<CmpPhotoSetRef> getCmpPhotoSetRefListByCompanyIdAndPhotoId(
			long companyId, long photoId);

	Map<Long, CmpPhotoSet> getCmpPhotoSetMapByCompanyIdAndInId(long companyId,
			List<Long> idList);
}