...
public class HaloValidate {
	 ...
	 *         2010-6-8
	 */
	public static boolean validateEmptyAndLength(String value, boolean toText,
			int maxLen) {
	 ...
	 *         2010-6-8
	 */
	public static boolean validateLength(String value, boolean toText,
			int maxLen) {
		if (DataUtil.isEmpty(value)) {
			return true;
		}
