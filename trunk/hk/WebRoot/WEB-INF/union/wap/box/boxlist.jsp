...
<div class="row"><hk:a href="/union/box.do?uid=${uid }&boxId=${b.boxId}">${b.name}</hk:a></div></c:forEach></c:if>
<div class="row"><hk:simplepage2 href="/union/box_list.do?uid=${uid}"/></div>
<div class="row">
