...
<hk:wap title="创建联系信息" rm="false" bodyId="thepage">
	<jsp:include page="../inc/top.jsp"></jsp:include>
	<div class="hang">创建联系信息</div>
	<div class="hang odd">
	<c:set var="orderformuserinfoform_action" scope="request">/op/orderformuser_createwap.do</c:set>
