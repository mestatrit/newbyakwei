...
<c:set var="view_title"><hk:data key="view.companyreview.title.editreview"/></c:set>
<hk:wap title="${view_title} - 火酷" rm="false" bodyId="thepage">
	<jsp:include page="../../inc/top.jsp"></jsp:include>
	<div class="hang even" onkeydown="submitLaba(event)">
		<hk:data key="view.companyreview.title.editreview"/><br/>
		<c:set var="form_action" value="/review/op/op_edit.do" scope="request"/>
