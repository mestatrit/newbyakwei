...
<c:set var="view_title"><hk:data key="e.admin.bizclelist.title"/></c:set>
<hk:wap title="${view_title} - 火酷" rm="false" bodyId="thepage">
	...
	<div class="hang">
		<hk:rmBlankLines rm="true">
			...
			<hk:a href="/e/admin/admin_findcity.do?f=bizclelist"><hk:data key="view.selectcityzone"/></hk:a>
		</hk:rmBlankLines>
	</div>
	<div class="hang">
		<hk:form method="get" action="/e/admin/admin_bizclelist.do">
			<hk:hide name="cityId" value="${cityId}"/>
			<hk:hide name="provinceId" value="${provinceId}"/>
			<hk:data key="e.admin.bizclelist.name"/>:<br/>
			<hk:text name="name" value="${name}"/><br/>
			<hk:submit value="e.admin.bizclelist.find" res="true"/>
		</hk:form>
	</div>
	...
	<div class="hang"><hk:a href="/e/admin/admin_toaddbizcle.do?cityId=${cityId }&provinceId=${provinceId }"><hk:data key="e.admin.bizclelist.addbizcle"/></hk:a></div>
