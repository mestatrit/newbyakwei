	...
	<div class="mgrright">
		<div class="mod">
			...
			<div class="mod_content">
				<div>
					<c:set var="form_action" scope="request"><%=path %>/epp/web/op/webadmin/cmpusertable_createusertabledata.do</c:set>
...
function createerr(error,err_msg,v){
	setHtml("_info",err_msg);
	submited=false;
	removeGlass(glassid);
}
function createok(error,err_msg,v){
