...
<div class="hcenter" style="width: 820px;">
	...
	<div class="mgrright">
		<div class="mod">
		<div class="mod_title">发布宝箱</div>
		<div class="mod_content">
		<br/>
			<div>
				<c:set var="form_action" scope="request"><%=path %>/epp/web/op/webadmin/box_create.do</c:set>
...
function createok(error,msg,v){
	tourl("<%=path %>/epp/web/op/webadmin/box_createprize.do?companyId=${companyId}&navoid=${navoid }&boxId="+v);
}
$(function()
	{
