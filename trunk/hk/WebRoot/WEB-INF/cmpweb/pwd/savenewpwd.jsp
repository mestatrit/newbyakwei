...
<c:set var="html_title" scope="request"><hk:data key="epp.pwd.resetpwd"/></c:set>
<c:set var="html_body_content" scope="request">
<div class="hcenter" style="width: 700px">
	<div class="mod">
		<div class="mod_title"><hk:data key="epp.pwd.resetpwd"/></div>
		<div class="mod_content">
			<form id="frm" method="post" onsubmit="return subpwdfrm(this.id)" action="<%=path %>/epp/web/pwd_savenewpwd.do" target="hideframe">
...
function pwdok(error,error_msg,respValue){
	hideGlass();
	tourl('<%=path %>/epp/login_web.do?companyId=${companyId}');
}
