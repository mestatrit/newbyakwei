<%@ page language="java" pageEncoding="UTF-8"%><%@page import="com.hk.frame.util.ServletUtil"%><%@page import="com.hk.web.util.JspDataUtil"%><%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%><%@ taglib uri="/WEB-INF/waphk.tld" prefix="hk"%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body <%if(body_attr_value!=null){ %><%=body_attr_value %><%} %> >
		<div id="body_div">
			<br class="linefix"/>
			<jsp:include page="cmpmgrtop.jsp"></jsp:include>
