...
<c:set var="html_title" scope="request"><hk:data key="view.friendfeed.title"/></c:set>
				...
				<div class="mid_con">
					<div class="mod">
						<c:set var="nav_2_short_content" scope="request">
							<a href="<%=path%>/userfeed_friend.do" class="nav-a"><hk:data key="view.friendfeed.title"/></a>
						</c:set>
						<jsp:include page="../inc/nav-2-short.jsp"></jsp:include>
					</div>
					<div class="mod">
						<c:set var="page_url" scope="request"><%=path%>/userfeed_friend.do?v=1</c:set>
