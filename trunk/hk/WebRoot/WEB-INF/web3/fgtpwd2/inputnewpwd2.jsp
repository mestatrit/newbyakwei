...
<c:set var="html_title" scope="request">更改密码</c:set>
<c:set var="body_hk_content" scope="request">
	<div class="mod text_14">
		<hk:form oid="fgtpwdfrm" action="/fgtpwd2_savenewpwd2.do" onsubmit="return subfgtpwdfrm(this.id)" target="hideframe">
			输入新的密码:<br/>
