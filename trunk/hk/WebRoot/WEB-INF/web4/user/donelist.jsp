	...
	<div class="lcon">
		<div class="inner">
			<div class="f_l">
				...
				<div id="do" class="active_tips_tab"><a href="/user/${userId }/done"><hk:data key="view2.last"/></a></div>
				<div id="todo" class="inactive_tips_tab"><a href="/user/${userId }/todo"><hk:data key="view2.todo"/></a></div>
				<div class="clr"></div>
				<div id="listbox" class="listbox">
					...
					<c:set var="page_url" scope="request">/user/${userId}/done</c:set>
