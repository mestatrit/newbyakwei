...
public class MsgAction extends EppBaseAction {
	...
	public String list(HkRequest req, HkResponse resp) throws Exception {
		...
		page.setTotalCount(this.cmpOrgMsgService
				.countCmpOrgMsgByCompanyIdAndOrgId(companyId, orgId));
		List<CmpOrgMsg> list = this.cmpOrgMsgService
				.getCmpOrgMsgListByCompanyIdAndOrgId(companyId, orgId, page
	...
	public String del(HkRequest req, HkResponse resp) throws Exception {
		...
		CmpOrgMsg cmpOrgMsg = this.cmpOrgMsgService
				.getCmpOrgMsg(companyId, oid);
