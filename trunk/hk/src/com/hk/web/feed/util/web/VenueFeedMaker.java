...
public class VenueFeedMaker implements FeedMaker {
	...
	public String getContentForWeb(HttpServletRequest request, FeedVo feedVo) {
		...
		String cmpdata = "<a href=\"/venue/" + feed.getCompanyId() + "\">"
				+ map.get("cmpname") + "</a>";
		return ResourceConfig.getText("feedcontent.createvenue", cmpdata);
	}
}