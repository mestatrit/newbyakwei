...
<table class="formt" cellpadding="0" cellspacing="0">
	<tr>
		...
		<td>
			<input maxlength="20" id="districtname" name="name" value="<hk:value value="${district.name }" onerow="true"/>" class="text"/>
	...
	<tr>
		...
		<td>
			...
			<a href="${appctx_path }/mgr/zone_districtlist.do?cityid=${cityid}">返回</a>
		</td>
	</tr>
</table>
</form>
<script type="text/javascript">
var err_code_<%=Err.DISTRICT_NAME_ERR %>={objid:"err_name"};
var err_code_<%=Err.DISTRICT_NAME_DUPLICATE%>={objid:"err_name"};
var glassid=null;
var submited=false;
