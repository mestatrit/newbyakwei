package com.hk.frame.util.upload.cos.multipart;
...
public class FilePart extends Part {
	 ...
	 * @param contentType the content type of the file provided in the MIME
	 *            header.
	 * @param fileName the file system name of the file provided in the MIME
	 *            header.
	 * @param filePath the file system path of the file provided in the MIME
	 *            header (as specified in disposition info).
	 ...
	 * Further note: if file rename logic is in effect, the file name can change
	 * during the writeTo() method when there's a collision with another file of
	 * the same name in the same directory. If this matters to you, be sure to
	 * pay attention to when you call the method.
	 * 
	 ...
	 * <code>null</code> if the user didn't enter a file to be uploaded. If
	 * path information was not supplied by the remote system, this method will
