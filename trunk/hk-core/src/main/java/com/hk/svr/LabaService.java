...
public interface LabaService {
	...
	List<Laba> getLabaListByCompanyIdFromCompanyRefLaba(long companyId,
			int begin, int size);

	List<Laba> getInformationLabaList(long userId, long tagId, int begin,
			int size);

	List<Laba> getInformationUserLabaList(long userId, long tagId, int begin,
			int size);

	// List<Laba> getLabaListFromLabaRootReply(long labaId, int begin, int
	// size);
	// List<Laba> getLabaListFromLabaReply(long labaId, int begin, int size);
	...
	List<TagLaba> getTagLabaListByUserId(long tagId, long userId, int begin,
			int size);
	...
	// List<LabaReply> getLabaReplyList(long labaId, int begin, int size);
	// List<LabaReply> getLabaReplyList(long labaId);
	// /**
	// * 获得喇叭的回复
	// *
	// * @param labaId
	// * @return
	// */
	// List<LabaReply> getLabaReplyListByReplyLabaId(long labaId);
	// /**
	// * 获得喇叭的最根源回复
	// *
	// * @param labaId 获得某个回复喇叭的根喇叭(类似于bbs中根据回复获取主贴)
	// * @return
	// */
	// List<LabaRootReply> getLabaRootReplyListByReplyLabaId(long labaId);
	/**
	 * 获得某个喇叭的所有回复，包括对回复的回复
	 * 
	 * @param labaId
	 * @return
	 */
	// List<LabaRootReply> getLabaRootReplyList(long labaId);
	// List<LabaRootReply> getLabaRootReplyList(long labaId, int begin, int
	// size);
	List<IpCityLaba> getIpCityLabaList(int ipCityId, int begin, int size);

	List<Laba> getIpLabaList(String ip, int begin, int size);

	List<IpCityRangeLaba> getIpCityRangeLabaList(int rangeId, int begin,
			int size);
	...
	List<UserLabaReply> getUserLabaReplyListByUserIdAndTime(long userId,
	 ...
	 * @return
	 */
	int counttUserLabaReplyListByUserIdAndTime(long userId, Date beginTime,
			Date endTime);
	 ...
	 * @return labaid的集合
	 */
	List<Long> getInformationLabaIdList(long userId, long tagId, int begin,
			int size);
	 ...
	 * @return
	 */
	List<Long> getInformationLabaIdListForMe(long userId, long tagId,
			int begin, int size);
	 ...
	 * @return
	 */
	List<CompanyRefLaba> getCompanyRefLabaList(long companyId, int begin,
			int size);
	 ...
	 * @return
	 */
	Map<Long, RefLaba> getRefLabaMapInLabaIdByRefUserId(long refUserId,
			List<Long> idList);
	...
	List<LabaCmt> getUserLabaCmtListByLabaId(long labaId, long userId,
			int begin, int size);
