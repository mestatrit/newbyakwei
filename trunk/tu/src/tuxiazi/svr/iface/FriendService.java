...
public interface FriendService {
	 ...
	 * 
	 * @param friend
	 * @param sendNotice true:向对方发送关注的通知,false:不发送通知
	 * @param getPhoto true:获取关注人的图片
	 */
	 ...
	 * @param userid
	 * @param friendid
	 * @param delPhoto 是否把此人的图片从关注图片中移除 true:移除
	 */
	...
	/**
	 * @param userid
	 * @param buildUser true:组装friend中的friendUser对象
	 * @param relationUserid 如果需要获得关注关系，就赋值为当前访问用户的userid
	 * @param begin
	 * @param size
	 * @return
	 *         2010-12-5
	...
	/**
	 * @param userid
	 * @param buildUser true:组装fans中的fansUser对象
	 * @param relationUserid 如果需要获得关注关系，就赋值为当前访问用户的userid
	 * @param begin
	 * @param size
	 * @return
