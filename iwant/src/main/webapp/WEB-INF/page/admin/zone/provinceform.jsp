...
<table class="formt" cellpadding="0" cellspacing="0">
	<tr>
		...
		<td>
			<input maxlength="20" id="provincename" name="name" value="<hk:value value="${province.name }" onerow="true"/>" class="text"/>
	...
	<tr>
		...
		<td>
			...
			<a href="${appctx_path }/mgr/zone_provincelist.do">返回</a>
		</td>
	</tr>
</table>
</form>
<script type="text/javascript">
var err_code_<%=Err.PROVINCE_NAME_ERR %>={objid:"err_name"};
var err_code_<%=Err.PROVINCE_NAME_DUPLICATE%>={objid:"err_name"};
var glassid=null;
var submited=false;
...
function createok(err,err_msg,v){
	tourl('${appctx_path}/mgr/zone_provincelist.do');
}
