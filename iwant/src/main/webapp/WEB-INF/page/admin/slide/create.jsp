...
%>
<c:set var="html_head_title" scope="request"><hk:value value="${ppt.name}"/> - 创建Slide</c:set>
<c:set scope="request" var="mgr_body_content">
<div class="mod">
	<div class="mod_title">
		<hk:value value="${ppt.name}"/> - 创建Slide
	</div>
	<div class="mod_content">
		<div>
			<c:set var="form_action" scope="request">${appctx_path}/mgr/slide_create.do</c:set>
