...
/**
 * url运行方式:http://localhost:8080/heloweb/hello/{methodname}.do
 * 
 * @author akwei
 */
@Component("/hello")
public class HelloAction {
    ...
    public String say(HkRequest req, HkResponse resp) {
        String name = "测试中文" + req.getInt("name");
        String key = "key" + req.getStringRow("key", "");
    ...
    public String say0(HkRequest req, HkResponse resp) {
        return "r:/hello/say.do?name=233&key=hello";
    }
