...
@Component("/epp/web/op/webadmin/actor")
public class ActorAction extends EppBaseAction {
	...
	public String execute(HkRequest req, HkResponse resp) throws Exception {
		...
		return this.getWebPath("admin/actor/list.jsp");
	}
	...
	public String rolelist(HkRequest req, HkResponse resp) throws Exception {
		...
		req.setAttribute("list", list);
		return this.getWebPath("admin/actor/rolelist.jsp");
	}
	...
	public String createrole(HkRequest req, HkResponse resp) throws Exception {
		...
		if (this.isForwardPage(req)) {
			return this.getWebPath("admin/actor/createrole.jsp");
		}
		long companyId = req.getLong("companyId");
	...
	public String updaterole(HkRequest req, HkResponse resp) throws Exception {
		...
		if (this.isForwardPage(req)) {
			...
			return this.getWebPath("admin/actor/updaterole.jsp");
		}
		cmpActorRole.setName(req.getHtmlRow("name"));
		int code = cmpActorRole.validate();
		if (code != Err.SUCCESS) {
	...
	public String createactor(HkRequest req, HkResponse resp) {
		req.setAttribute("active_36", 1);
		if (this.isForwardPage(req)) {
			return this.getWebPath("admin/actor/createactor.jsp");
		}
		long companyId = req.getLong("companyId");
	...
	public String updateactor(HkRequest req, HkResponse resp) {
		...
		if (this.isForwardPage(req)) {
			...
			return this.getWebPath("admin/actor/updateactor.jsp");
		}
		cmpActor.setName(req.getHtmlRow("name"));
		cmpActor.setCompanyId(companyId);
		cmpActor.setRoleId(req.getLong("roleId"));
	...
	public String addsvrforactor(HkRequest req, HkResponse resp) {
		...
		if (this.isForwardPage(req)) {
			...
			List<CmpActorSvrRef> reflist = this.cmpSvrService
					.getCmpActorSvrRefListByCompanyIdAndActorId(companyId,
							actorId);
			List<Long> svrIdList = new ArrayList<Long>();
			for (CmpActorSvrRef o : reflist) {
				svrIdList.add(o.getSvrId());
			}
			List<CmpSvrVo> volist = new ArrayList<CmpSvrVo>();
			for (CmpSvr o : list) {
				CmpSvrVo vo = new CmpSvrVo();
				vo.setCmpSvr(o);
				if (svrIdList.contains(o.getSvrId())) {
					vo.setSelected(true);
					for (CmpActorSvrRef ref : reflist) {
						if (ref.getSvrId() == o.getSvrId()) {
							vo.setCmpActorSvrRef(ref);
							break;
						}
					}
				}
			...
			return this.getWebPath("admin/actor/svrlist.jsp");
		}
	...
	public String setworkday(HkRequest req, HkResponse resp) {
		...
		if (this.isForwardPage(req)) {
			...
			return this.getWebPath("admin/actor/workday.jsp");
		}
	...
	public String sptimelist(HkRequest req, HkResponse resp) {
		...
		return this.getWebPath("admin/actor/sptimelist.jsp");
	}
	...
	public String createactorsptime(HkRequest req, HkResponse resp) {
		...
		long actorId = req.getLongAndSetAttr("actorId");
		if (this.isForwardPage(req)) {
			return this.getWebPath("admin/actor/createactorsptime.jsp");
		}
	...
	public String updatestatus(HkRequest req, HkResponse resp) {
		...
		if (this.isForwardPage(req)) {
			req.setAttribute("cmpActor", cmpActor);
			return this.getWebPath("admin/actor/updatestatus.jsp");
		}
