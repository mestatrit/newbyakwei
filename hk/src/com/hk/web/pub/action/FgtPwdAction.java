	...
	public String toInputProtect(HkRequest req, HkResponse resp) {
		...
		if (userProtect == null) {
			try {
				...
				String content = req.getText("func.mail.fgtpwd.mail.content",
						value);
				...
				// this.mailUtil.sendHtmlMail("ak478288@163.com", title,
				// content);
				return "/WEB-INF/page/pub/fgtpwd/emailsendok.jsp";
			}
			catch (SendOutOfLimitException e) {
				req.setMessage(req
						.getText("func.mail.fgtpwd.mail.sendfail_limit"));
				return "/WEB-INF/page/pub/fgtpwd/emailsendok.jsp";
			}
