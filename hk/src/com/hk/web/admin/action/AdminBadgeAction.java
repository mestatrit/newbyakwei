...
public class AdminBadgeAction extends BaseAction {
	...
	public String execute(HkRequest req, HkResponse resp) throws Exception {
		...
		List<Badge> list = this.badgeService.getBadgeList(name,
	...
	public String createnolimit(HkRequest req, HkResponse resp) {
		...
		try {
			...
			return "r:/admin/badge_view.do?badgeId=" + o.getBadgeId()
					+ "&continue=1&limitflg=" + Badge.LIMITFLG_N;
		}
	...
	public String createinvite(HkRequest req, HkResponse resp) {
		...
		try {
			...
			this.setOpFuncSuccessMsg(req);
			return "r:/admin/badge_view.do?badgeId=" + o.getBadgeId()
					+ "&continue=1&limitflg=" + Badge.LIMITFLG_INVITE;
		}
		catch (ImageException e) {
			req.setText(String.valueOf(Err.IMG_UPLOAD_ERROR));
	...
	public String createsys(HkRequest req, HkResponse resp) {
		...
		try {
			...
			this.setOpFuncSuccessMsg(req);
			return "r:/admin/badge_view.do?badgeId=" + o.getBadgeId()
					+ "&continue=1&limitflg=" + Badge.LIMITFLG_SYS;
		}
		catch (ImageException e) {
			req.setText(String.valueOf(Err.IMG_UPLOAD_ERROR));
	...
	public String createcycle(HkRequest req, HkResponse resp) {
		...
		try {
			...
			this.setOpFuncSuccessMsg(req);
			return "r:/admin/badge_view.do?badgeId=" + o.getBadgeId()
					+ "&continue=1&limitflg=" + Badge.LIMITFLG_Y + "&ruleflg="
					+ Badge.RULEFLG_CMP_CYCLE_CHECKIN_NUM;
		}
		catch (ImageException e) {
			req.setText(String.valueOf(Err.IMG_UPLOAD_ERROR));
	...
	public String createparentkindcheckin(HkRequest req, HkResponse resp) {
		...
		map.put("checkinnum", String.valueOf(num));
		map
				.put("parentname", CompanyKindUtil.getParentKind(parentId)
						.getName());
		o.setRuleData(DataUtil.toJson(map));
		try {
			this.badgeService.createBadge(o, file);
			...
			return "r:/admin/badge_view.do?badgeId=" + o.getBadgeId()
					+ "&continue=1&limitflg=" + Badge.LIMITFLG_Y + "&ruleflg="
					+ Badge.RULEFLG_CMPKIND_CHECKIN_NUM;
		}
		catch (ImageException e) {
			req.setText(String.valueOf(Err.IMG_UPLOAD_ERROR));
	...
	public String createkindcheckin(HkRequest req, HkResponse resp) {
		...
		try {
			...
			return "r:/admin/badge_view.do?badgeId=" + o.getBadgeId()
					+ "&continue=1&limitflg=" + Badge.LIMITFLG_Y + "&ruleflg="
					+ Badge.RULEFLG_CMPCHILDKIND_CHECKIN_NUM;
		}
		catch (ImageException e) {
			req.setText(String.valueOf(Err.IMG_UPLOAD_ERROR));
	...
	public String createcmpgroupcheckin(HkRequest req, HkResponse resp) {
		...
		CmpAdminGroup group = this.cmpAdminGroupService
				.getCmpAdminGroup(groupId);
		...
		try {
			...
			return "r:/admin/badge_view.do?badgeId=" + o.getBadgeId()
					+ "&continue=1&limitflg=" + Badge.LIMITFLG_Y + "&ruleflg="
					+ Badge.RULEFLG_CMPGROUP_CHECKIN_NUM;
		}
		catch (ImageException e) {
			req.setText(String.valueOf(Err.IMG_UPLOAD_ERROR));
	...
	public String editcmpgroupcheckin(HkRequest req, HkResponse resp) {
		...
		CmpAdminGroup group = this.cmpAdminGroupService.getCmpAdminGroup(o
				.getGroupId());
		req.setAttribute("cmpAdminGroup", group);
		req.setAttribute("o", o);
		if (req.getInt("ch") == 0) {
	...
	public String editparentkindcheckin(HkRequest req, HkResponse resp) {
		...
		req.setAttribute("parentKind", CompanyKindUtil.getParentKind(o
				.getParentKindId()));
		req.setAttribute("o", o);
		if (req.getInt("ch") == 0) {
		...
		Map<String, String> map = new HashMap<String, String>();
		map.put("checkinnum", String.valueOf(num));
		map.put("parentname", CompanyKindUtil
				.getParentKind(o.getParentKindId()).getName());
		o.setRuleData(DataUtil.toJson(map));
		try {
			this.badgeService.updateBadge(o, file);
			this.setOpFuncSuccessMsg(req);
	...
	public String editkindcheckin(HkRequest req, HkResponse resp) {
		...
		Map<String, String> map = new HashMap<String, String>();
		map.put("checkinnum", String.valueOf(num));
		map.put("kindname", CompanyKindUtil.getCompanyKind(o.getKindId())
				.getName());
		o.setRuleData(DataUtil.toJson(map));
		try {
			this.badgeService.updateBadge(o, file);
	...
	public String view(HkRequest req, HkResponse resp) {
		...
		if (o.getGroupId() > 0) {
			o.setCmpAdminGroup(this.cmpAdminGroupService.getCmpAdminGroup(o
					.getGroupId()));
		}
	...
	public String searchcmpadmingroup(HkRequest req, HkResponse resp) {
		...
		if (ch == 1 && name != null) {
			...
			List<CmpAdminGroup> list = this.cmpAdminGroupService
					.getCmpAdminGroupList(name, page.getBegin(),
							page.getSize() + 1);
			this.processListForPage(page, list);
			req.setAttribute("list", list);
			req.setEncodeAttribute("name", name);
	...
	public String kindlist(HkRequest req, HkResponse resp) {
		int parentId = req.getIntAndSetAttr("parentId");
		List<CompanyKind> list = CompanyKindUtil
				.getCompanyKindListByParentKindId(parentId);
		req.reSetAttribute("method");
		req.setAttribute("list", list);
	...
	public String op(HkRequest req, HkResponse resp) {
		return "r:/admin/badge_" + req.getString("method") + ".do?companyId="
				+ req.getLong("companyId") + "&groupId="
				+ req.getLong("groupId") + "&parentId="
				+ req.getInt("parentId") + "&kindId=" + req.getInt("kindId");
	}
	...
	public String create(HkRequest req, HkResponse resp) {
		...
		if (limitflg == Badge.LIMITFLG_Y) {
			...
			if (ruleflg == Badge.RULEFLG_CMPCHILDKIND_CHECKIN_NUM) {
				return "r:/admin/badge_kindlist.do?parentId="
						+ req.getInt("parentId");
			}
		}
	...
	public String edit(HkRequest req, HkResponse resp) {
		...
		if (badge.isLimit()) {
			...
			if (badge.getRuleflg() == Badge.RULEFLG_CMPGROUP_CHECKIN_NUM) {
				return "r:/admin/badge_editcmpgroupcheckin.do?badgeId="
						+ badgeId;
			}
			if (badge.getRuleflg() == Badge.RULEFLG_CMPKIND_CHECKIN_NUM) {
				return "r:/admin/badge_editparentkindcheckin.do?badgeId="
						+ badgeId;
			}
