...
<%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions"%><%@ taglib uri="/WEB-INF/waphk.tld" prefix="hk"%>
<hk:wap title="@${user.nickName} - 火酷" rm="false" bodyId="thepage">
	<jsp:include page="../inc/top.jsp"></jsp:include>
	<div class="hang">@${user.nickName}</div>
	<div class="hang">
	...
	<c:if test="${fn:length(labavolist)>0}">
		<c:set var="addlabastr" value="from=reuser&ouserId=${userId }" scope="request"/>
		<jsp:include page="../inc/labavo2.jsp"></jsp:include>
		<hk:simplepage2 href="/laba/reuserlist.do?userId=${userId}"/>
	</c:if>
