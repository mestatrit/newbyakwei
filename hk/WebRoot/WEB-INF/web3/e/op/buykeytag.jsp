	...
	<div style="padding-left: 20px;">
		<table class="infotable" cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td width="90px"></td>
				<td>
					<strong class="text_14">当前余额 ${company.money }</strong>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					<div class="f_l" style="width: 200px;">
						...
						<c:if test="${move_money==null || move_money<=0}">
							<hk:text name="money" maxlength="50" clazz="text_short_1"/>元<br/>
						</c:if>
						<div id="hkobjkeytagorder_money_error" class="error"></div>
					</div>
					<div id="hkobjkeytagorder_money_flag" class="flag"></div><div class="clr"></div>
				</td>
			</tr>
			<tr>
				...
				<td>
					...
					<div id="hkobjkeytagorder_pday_flag" class="flag"></div><div class="clr"></div>
				</td>
			</tr>
			<tr>
				<td width="90px"></td>
			...
			<tr>
				<td colspan="2">
					<div class="f_l">
						<input type="submit" value="马上购买" class="btn"/>
