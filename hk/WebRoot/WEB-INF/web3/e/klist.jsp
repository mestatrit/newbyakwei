...
<c:set var="html_title" scope="request">${companyKind.name} - 火酷网</c:set>
<c:set var="body_hk_content" scope="request">
	...
	<div class="mod_primary">
		...
		<div class="mod_primary_l">
			...
			<c:set var="page_url" scope="request">/cmp_klist.do?parentId=${parentId }&kindId=${kindId}&pcityId=${pcityId}</c:set>
