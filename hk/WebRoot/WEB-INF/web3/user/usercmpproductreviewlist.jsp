...
<c:set var="html_title" scope="request"><hk:data key="view.user_company_product_review.title" arg0="${user.nickName}" /></c:set>
	...
	<table class="frame-3" cellpadding="0" cellspacing="0">
		<tr>
			...
			<td class="mid">
				<div class="mid_con">
					<div class="mod">
						<c:set var="nav_2_short_content" scope="request"><a href="<%=path %>/usercmpproductreview.do?userId=${userId }" class="nav-a"><hk:data key="view.user_company_product_review.title" arg0="${user.nickName}" /></a></c:set>
