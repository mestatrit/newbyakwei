...
%><c:set var="html_head_title" scope="request">${tbUser.show_nick }拥有的宝贝
</c:set><c:set var="html_head_value" scope="request">
<meta name="description" content="${tbUser.show_nick }拥有的宝贝" />
<meta name="keywords"  content="${tbUser.show_nick }拥有的宝贝|顾问家" />
</c:set><c:set var="html_body_content" scope="request">
	<div class="pl">
		<div class="mod">
			<div class="mod_title">${tbUser.show_nick }拥有的宝贝
			<a class="more" href="/p/${userid }">返回</a>
			</div>
			<div class="mod_content">
				<jsp:include page="itemdata2_inc.jsp"></jsp:include>
				<div>
				<c:set var="page_url" scope="request">${ctx_path}/tb/user_holditem?userid=${userid}</c:set>
