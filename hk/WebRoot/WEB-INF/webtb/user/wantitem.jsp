...
%><c:set var="html_head_title" scope="request">${tbUser.show_nick }想买的宝贝
...
<meta name="keywords"  content="${tbUser.show_nick }评价的宝贝|顾问家" />
	...
	<div class="pl">
		<div class="mod">
			<div class="mod_title">${tbUser.show_nick }想买的宝贝
			...
			<div class="mod_content">
				<div style="padding-left: 20px;">
					...
					<div class="clr"></div>
					<div>
					<c:set var="page_url" scope="request">${ctx_path}/tb/user_wantitem?userid=${userid}</c:set>
