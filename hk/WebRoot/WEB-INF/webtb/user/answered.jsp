...
%><c:set var="html_head_title" scope="request">${tbUser.show_nick }回答的问题
</c:set><c:set var="html_head_value">
<meta name="description" content="${tbUser.show_nick }回答的问题" />
<meta name="keywords"  content="${tbUser.show_nick }回答的问题|顾问家" />
</c:set><c:set var="html_body_content" scope="request">
<div class="pl">
	<div class="mod">
		<div class="mod_title">${tbUser.show_nick }回答的问题
		...
		<div class="mod_content">
			<ul class="itemcmtlist">
				...
				<li>
					<div class="head">
						<a href="/p/${user_ask.tbAsk.userid }"><img src="${user_ask.tbAsk.tbUser.pic_url_48 }"/><br/>${user_ask.tbAsk.tbUser.show_nick }</a>
					</div>
					<div class="body">
