...
<link rel="stylesheet" type="text/css" href="<%=path %>/webst4/css/imgcut/imgareaselect-default.css" />
<script type="text/javascript" src="<%=path %>/webst4/js/imgcut/jquery.imgareaselect.min.js"></script>
</c:set>
			...
			<tr>
				...
				<td width="50%">
					<div style="margin-left: 20px;">
						...
						<br/>
						<hk:form oid="op_frm" onsubmit="return checkopfrm(this.id)" action="/h4/op/user/set_sethead2.do" target="hideframe">
...
function setheadok(err,error_msg,v){
	tourl('<%=path%>/h4/op/user/set_sethead.do');
}
