...
<div class="mod">
	...
	<div class="mod_content">
		<div class="divrow">
			<form id="frm" method="post" onsubmit="return subfrm(this.id)" action="<%=path %>/h4/admin/authcmp_checkokforupdate.do" target="hideframe">
				<hk:hide name="sysId" value="${sysId}"/>
				<hk:hide name="companyId" value="${authCompany.companyId}"/>
