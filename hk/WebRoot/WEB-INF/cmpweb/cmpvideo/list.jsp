	...
	<div class="mod">
		...
		<div class="mod_content">
			...
			<div class="divrow" onmouseover="this.className='divrow bg3'" onmouseout="this.className='divrow'">
				<a href="<%=path %>/epp/web/video_view.do?companyId=${companyId}&navId=${navId }&oid=${file.oid}">${file.name }</a>
			</div>
			</c:forEach>
			<div>
				<c:set var="page_url" scope="request"><%=path%>/epp/web/video.do?companyId=${companyId}&navId=${navId}</c:set>
