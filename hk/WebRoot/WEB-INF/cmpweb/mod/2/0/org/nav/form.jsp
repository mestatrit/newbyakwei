...
<form id="articlefrm" method="post" onsubmit="return subfrm(this.id)" action="${cmpnav_form_action }" target="hideframe">
	...
	<table class="nt all" cellpadding="0" cellspacing="0">
		<tr>
			<td width="70">名称：</td>
			<td>
				<hk:text name="name" value="${cmpOrgNav.name}" clazz="text" maxlength="50"/>
		...
		<tr>
			...
			<td>
				...
				<a href="<%=path %>/epp/web/org/org_navlist.do?companyId=${companyId}&orgId=${orgId}">返回</a>
			</td>
		</tr>
	</table>
</form>
<script type="text/javascript">
var err_code_<%=Err.CMPORGNAV_NAME_ERROR %>={objid:"_name"};
