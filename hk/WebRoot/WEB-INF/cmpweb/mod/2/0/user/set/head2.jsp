...
<link rel="stylesheet" type="text/css" href="<%=path %>/cmpwebst4/mod/pub/css/imgcut/imgareaselect-default.css" />
<script type="text/javascript" src="<%=path %>/cmpwebst4/mod/pub/js/imgcut/jquery.imgareaselect.min.js"></script>
</c:set>
...
<div class="hcenter">
	<div class="pr" style="width: 750px">
		<div>
