...
<form id="frm" method="post" onsubmit="return subfrm(this.id)" action="${form_action }" target="hideframe">
	...
	<table class="nt all" cellpadding="0" cellspacing="0">
		<tr>
			...
			<td>
				<hk:text name="name" clazz="text" value="${cmpPhotoSet.name}"/> 
		...
		<tr>
			...
			<td>
				...
				<a href="<%=path %>/epp/web/op/webadmin/info_photosetlist.do?companyId=${companyId}">返回</a>
			</td>
		</tr>
	</table>
</form>
<script type="text/javascript">
var err_code_<%=Err.CMPPHOTOSET_NAME_ERROR %>={objid:"_name"};
