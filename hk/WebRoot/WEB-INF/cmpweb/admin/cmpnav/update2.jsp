...
<div class="hcenter" style="width: 820px;">
	...
	<div class="mgrright">
		<div class="mod">
		<div class="mod_title">修改二级栏目 ${cmpNav.name}</div>
		<div class="mod_content">
		<br/>
			<div>
				<c:set var="cmpnav_form_action" scope="request"><%=path %>/epp/web/op/webadmin/admincmpnav_update2.do</c:set>
...
check_navcontentref(${cmpNav.reffunc});
</script>
