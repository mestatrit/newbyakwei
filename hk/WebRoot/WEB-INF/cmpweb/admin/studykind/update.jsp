...
<div class="hcenter" style="width: 820px;">
	...
	<div class="mgrright">
		<div class="mod">
		<div class="mod_title">${cmpNav.name } 修改专业
			<a class="more" href="<%=path %>/epp/web/op/webadmin/studykind.do?companyId=${companyId}&parentId=${parentId }">返回</a>
		</div>
		<div class="mod_content">
			<div>
				<c:set var="cmpnav_form_action" scope="request"><%=path %>/epp/web/op/webadmin/studykind_update.do</c:set>
...
function updateok(error,msg,v){
	tourl("<%=path %>/epp/web/op/webadmin/studykind.do?companyId=${companyId}&parentId=${parentId}");
}
</script>
