...
//  alert(document.documentElement.clientWidth + ',' + (hovertipMouseX + obj_width));
  if(hovertipMouseX + obj_width+50>document.documentElement.clientWidth){
	  var ch_amout=(hovertipMouseX + obj_width+50) - document.documentElement.clientWidth;
	  hovertipMouseX=hovertipMouseX-ch_amout;
  }
};
