...
if(referer==null || referer.indexOf("/epp/web/op/webadmin/admincmpnav_setmap.do?companyId=")==-1){
	return;
}
...
function updateCompanyLocation(o){
	...
	$.ajax({
		type:"POST",
		url:"/index_savepos.do?companyId="+companyId+"&marker_x="+marker_x+"&marker_y="+marker_y+"&op=<%=op%>",
		cache:false,
    	dataType:"html",
